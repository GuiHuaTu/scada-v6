...
{
    /// <summary>
    /// The phrases used in the SiemensS7 protocol implementation.
    /// <para>Фразы, используемые в реализации протокола SiemensS7.</para>
    /// </summary>
    public static class SiemensS7Phrases
    {
        // Scada.Comm.Drivers.DrvSiemensS7.Config
        public static string LoadTemplateError { get; private set; }
        public static string SaveTemplateError { get; private set; }

        // Scada.Comm.Drivers.DrvSiemensS7.Protocol
