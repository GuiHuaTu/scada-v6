...
{
    /// <summary>
    /// The class contains utility methods for the SiemensS7 protocol implementation.
    /// <para>Класс, содержащий вспомогательные константы и методы для реализации протокола SiemensS7.</para>
    /// </summary>
    public static class SiemensS7Utils
    {
        /// <summary>
        ...
        /// <summary>
        /// The default SiemensS7 TCP port.
        /// </summary>
        ...
        /// </summary>
        /// <remarks>The method is taken from the official SiemensS7 specification.</remarks>
        ...
        /// </summary>
        public static string GetAddressRange(string address, int count, bool decAddr)
        { 

            string format = decAddr ? "G" : "X";
            string suffix = decAddr ? "" : "H";
            return address.ToString() + suffix + 
