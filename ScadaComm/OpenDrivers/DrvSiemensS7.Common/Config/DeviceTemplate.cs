...
namespace Scada.Comm.Drivers.DrvSiemensS7.Config
{
    ...
    public class DeviceTemplate : DeviceConfigBase
    {
        ...
        /// </summary>
        public virtual string NewTemplateFileName => "DrvSiemensS7_NewTemplate.xml";
        ...
        {
            return ex.BuildErrorMessage(SiemensS7Phrases.LoadTemplateError);
        }
        ...
        {
            return ex.BuildErrorMessage(SiemensS7Phrases.SaveTemplateError);
        }
