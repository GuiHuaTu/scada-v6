            ...
            switch (byteCnt)
            {
                case 2:
                    if (byteOrderArr2 == null)
                        byteOrderArr2 = SiemensS7Utils.ParseByteOrder(DefByteOrder2);
                    return byteOrderArr2;

                case 4:
                    if (byteOrderArr4 == null)
                        byteOrderArr4 = SiemensS7Utils.ParseByteOrder(DefByteOrder4);
                    return byteOrderArr4;

                case 8:
                    if (byteOrderArr8 == null)
                        byteOrderArr8 = SiemensS7Utils.ParseByteOrder(DefByteOrder8);
