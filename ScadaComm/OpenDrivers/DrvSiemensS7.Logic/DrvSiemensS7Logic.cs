...
namespace Scada.Comm.Drivers.DrvSiemensS7.Logic
{
    ...
    /// </summary>
    public class DrvSiemensS7Logic : DriverLogic
    {
        /// <summary>
        /// Initializes a new instance of the class.
        /// </summary>
        public DrvSiemensS7Logic(ICommContext commContext)
            : base(commContext)
        {
        }
        ...
        {
            return new DevSiemensS7Logic(CommContext, lineContext, deviceConfig);
        }
    }
}
