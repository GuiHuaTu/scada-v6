...
namespace Scada.Comm.Drivers.DrvSiemensS7.View
{
    ...
    /// </summary>
    public class DevSiemensS7View : DeviceView
    {
        ...
        /// </summary>
        public DevSiemensS7View(DriverView parentView, LineConfig lineConfig, DeviceConfig deviceConfig, 
            ...
            foreach (ElemGroupConfig elemGroupConfig in deviceTemplate.ElemGroups)
            {
                foreach (ElemConfig elemConfig in elemGroupConfig.Elems)
                {
                    ...
                    if (elemConfig.IsBitMask && elemConfig.ElemType != ElemType.Bool)
                    {
                        ...
                        for (int bit = 0, bitCnt = SiemensS7Utils.GetDataLength(elemConfig.ElemType) * 8; 
                            bit < bitCnt; bit++)
                        {
                            cnlPrototypes.Add(new CnlPrototype
                            {
