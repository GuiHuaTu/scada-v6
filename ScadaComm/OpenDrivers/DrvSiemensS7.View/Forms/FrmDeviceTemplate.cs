...
using Scada.Comm.Drivers.DrvSiemensS7.View.Properties;
using Scada.Forms;
using Scada.Lang;
    ...
    public partial class FrmDeviceTemplate : Form
    {
        ...
        private void FillTree()
        {
            ...
            try
            {
                ...
                // fill commands
                foreach (CmdConfig siemensS7Cmd in template.Cmds)
                {
                    commandsNode.Nodes.Add(CreateCmdNode(siemensS7Cmd));
                }
        ...
        private TreeNode CreateElemGroupNode(ElemGroupConfig elemGroup)
        {
            ...
            //string elemAddr = elemGroup.Address;
        ...
        private static string GetElemGroupNodeText(ElemGroupConfig elemGroup)
        {
            return string.Format("{0} ({1})",
                ...
                SiemensS7Utils.GetDataBlockName(elemGroup.DataBlock));
        }
        ...
        private string GetCmdNodeText(CmdConfig cmd)
        {
            ...
            string blockName = SiemensS7Utils.GetDataBlockName(cmd.DataBlock);
            ...
            //else
            {
                //string addrRange = SiemensS7Utils.GetAddressRange(cmd.Address,
                //    cmd.ElemCnt * cmd.Quantity,  template.Options.DecAddr);
                //return string.Format("{0} ({1}, {2})", cmdName, blockName, addrRange);
                string address = cmd.Address;
                return string.Format("{0} ({1}, {2})", cmdName, blockName, address);
            }
        }
        ...
        private void ctrlElemGroup_ObjectChanged(object sender, ObjectChangedEventArgs e)
        {
            ...
            if (treeUpdateTypes.HasFlag(TreeUpdateTypes.ChildCount))
            {
                ...
                if (oldElemCnt < newElemCnt)
                {
                    ...
                    //string elemAddr = selectedElemGroup.Address;
